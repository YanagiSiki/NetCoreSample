...
(function (w) {
	...
	let totalPage = $page.data('totalpage') || 10;
	...
	else $pagination.append(`<li class="page-item"><a class="page-link" href="${currentPage-1}" aria-label="Previous"><span aria-hidden="true">&lsaquo;</span></a></li>`);
	...
	else $pagination.append(`<li class="page-item"><a class="page-link" href="${currentPage+1}" aria-label="Next"><span aria-hidden="true">&rsaquo;</span></a></li>`);
