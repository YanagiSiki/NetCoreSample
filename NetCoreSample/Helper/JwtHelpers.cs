...
{
    /// <summary>
    /// ref https://blog.miniasp.com/post/2019/12/16/How-to-use-JWT-token-based-auth-in-aspnet-core-31
    /// </summary>
    public class JwtHelpers
    {
        ...
        /// <returns>jwt.GenerateToken(login.Username)</returns>
        public string GenerateToken(ClaimsIdentity userClaimsIdentity, int expireMinutes = 30)
        {
